...
class PostSerializer(serializers.ModelSerializer):
    ...
    def get_size(self, obj):
        return 5 # TODO figure out what size should be determined by

    def get_next(self, obj):
        return obj.source + '/comments'

    def get_comments(self, obj):
        return GETCommentSerializer(Comment.objects.filter(post_id=obj.post_id).all(), many=True).data
