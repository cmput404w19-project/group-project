...
class PostTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.post_id1 = uuid.uuid4()
        post1 = Post()
        post1.post_id = self.post_id1
        ...
        self.post_id2 = uuid.uuid4()
        post2 = Post()
        post2.post_id = self.post_id2
    ...
    def test_Post_attribute(self):
        post1 = Post.objects.get(post_id=self.post_id1)
        post2 = Post.objects.get(post_id=self.post_id2)
